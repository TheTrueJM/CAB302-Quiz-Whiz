...
public class ChatDAO implements IChatDAO {
    ...
    /**
     * Constructor for {@link ChatDAO} initializing chats table.
     *
     ...
     * <p>
     * The table stores chat preferences to customize quiz generation and AI responses.
     *
     * @throws SQLException if a database error occurs during table creation
     */
    ...
    /**
     * Saves a new {@link Chat} to the database.
     * <p>
     * This method inserts a {@link Chat} into the {@link chats} table, storing its user ID,
     * name, response attitude, quiz difficulty, quiz length, education level, and study area.
     * The chat ID is automatically generated by the SQLite database and set on the {@link Chat}
     * object to ensure uniqueness.
     *
     * @param chat the {@link Chat} object to save
    ...
    /**
     * Updates an existing {@link Chat} row in the database.
     * <p>
     * This method updates the name, response attitude, quiz difficulty, quiz length,
     * education level, and study area of a {@link Chat} identified by its ID. It ensures
     * the chat’s preferences are kept up-to-date when new values are set by the user.
     *
     * @param chat the {@link Chat} object with updated fields
