...
public class Chat {
    ...
    public Chat(int userId, String name, String responseAttitude, String quizDifficulty, String educationLevel,
            String studyArea) {
        this.userId = userId;
        this.name = name;
    ...
    public String getResponseAttitude() {
        return responseAttitude;
    }

    public void setResponseAttitude(String responseAttitude) {
        this.responseAttitude = responseAttitude;
    }
