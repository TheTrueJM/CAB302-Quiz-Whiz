...
public class AIUtils {
    ...
    /**
     * Structure of the an individual quiz generated by the AI.
     * <p>
     ...
     * It then parses the JSON content into a {@link ModelResponseFormat} object using Gson.
     * If the response does not contain valid JSON or if an error occurs during parsing,
     * it returns an error message in the {@link ModelResponseFormat}.
     *
