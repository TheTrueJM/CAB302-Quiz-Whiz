...
public class AuthControllerTest {
	...
	public void testSignUpEmptyUsername() {
		assertThrows(IllegalArgumentException.class, () -> authController.signUp("", User.get("password")));
	}

	@Test
	public void testSignUpNullUsername() {
		assertThrows(IllegalArgumentException.class, () -> authController.signUp(null, User.get("password")));
	}

	@Test
	public void testSignUpEmptyPassword() {
		assertThrows(IllegalArgumentException.class, () -> authController.signUp(User.get("username"), ""));
	}

	@Test
	public void testSignUpNullPassword() {
		assertThrows(IllegalArgumentException.class, () -> authController.signUp(User.get("username"), null));
	}
