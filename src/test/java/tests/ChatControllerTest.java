...
public class ChatControllerTest {
	...
	private static final User CurrentUser = new User("TestUser", User.hashPassword("password"));
	...
	public void testCreateNewChat() throws IllegalArgumentException, SQLException {
		...
		Chat newChat = chatController.createNewChat(chat.getName(), chat.getResponseAttitude(),
	...
	public void testCreateNewChatEmptyName() {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat("", chat.getResponseAttitude(),
				chat.getQuizDifficulty(), chat.getEducationLevel(), chat.getStudyArea()));
	}
	...
	public void testCreateNewChatNullName() {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat(null,
	...
	public void testCreateNewChatEmptyAttitude() {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat(chat.getName(), "",
				chat.getQuizDifficulty(), chat.getEducationLevel(), chat.getStudyArea()));
	}
	...
	public void testCreateNewChatNullAttitude() {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat(chat.getName(), null,
				chat.getQuizDifficulty(), chat.getEducationLevel(), chat.getStudyArea()));
	}
	...
	public void testCreateNewChatEmptyDifficulty() throws IllegalArgumentException, SQLException {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat(chat.getName(),
				chat.getResponseAttitude(), "", chat.getEducationLevel(), chat.getStudyArea()));
	}
	...
	public void testCreateNewChatNullDifficulty() {
		Chat chat = Chats.get("chat1");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChat(chat.getName(),
				chat.getResponseAttitude(), null, chat.getEducationLevel(), chat.getStudyArea()));
	}
	...
	public void testCreateNewChatEmptyEducation() throws IllegalArgumentException, SQLException {
		Chat chat = Chats.get("chat1");
		Chat newChat = chatController.createNewChat(chat.getName(), chat.getResponseAttitude(),
				chat.getQuizDifficulty(), "", chat.getStudyArea());
		assertNotNull(newChat);
	...
	public void testCreateNewChatNullEducation() throws IllegalArgumentException, SQLException {
		Chat chat = Chats.get("chat1");
		Chat newChat = chatController.createNewChat(chat.getName(), chat.getResponseAttitude(),
				chat.getQuizDifficulty(), null, chat.getStudyArea());
		assertNotNull(newChat);
		assertNull(newChat.getEducationLevel());
	}
	...
	public void testCreateNewChatEmptyStudyArea() throws IllegalArgumentException, SQLException {
		Chat chat = Chats.get("chat1");
		Chat newChat = chatController.createNewChat(chat.getName(), chat.getResponseAttitude(),
				chat.getQuizDifficulty(), chat.getEducationLevel(), "");
		assertNotNull(newChat);
	...
	public void testCreateNewChatNullStudyArea() throws IllegalArgumentException, SQLException {
		Chat chat = Chats.get("chat1");
		Chat newChat = chatController.createNewChat(chat.getName(), chat.getResponseAttitude(),
				chat.getQuizDifficulty(), chat.getEducationLevel(), null);
		assertNotNull(newChat);
		assertNull(newChat.getStudyArea());
	}
	...
	public void testGetUserChats() throws IllegalArgumentException, SQLException {
		for (Chat chat : Chats.values()) {
			chatController.createNewChat(chat.getName(), chat.getResponseAttitude(), chat.getQuizDifficulty(),
					chat.getEducationLevel(), chat.getStudyArea());
		}
	...
	public void testGetUserChatInvalidId() {
		assertThrows(NoSuchElementException.class, () -> chatController.getChat(1));
	}
	...
	public void testUpdateChatNameEmpty() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		assertThrows(IllegalArgumentException.class, () -> chatController.updateChatName(newChat.getId(), ""));
	...
	public void testUpdateChatNameNull() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		assertThrows(IllegalArgumentException.class, () -> chatController.updateChatName(newChat.getId(), null));
	...
	public void testUpdateChatNameInvalidId() {
		assertThrows(NoSuchElementException.class, () -> chatController.updateChatName(1, "New Chat Name"));
	}
	...
	public void testCreateNewChatMessage() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		Message newMessage = chatController.createNewChatMessage(message.getChatId(), message.getContent(),
				message.getFromUser(), message.getIsQuiz());
	...
	public void testCreateNewChatMessageInvalidChatId() {
		Message message = Messages.get("messageUser");
		assertThrows(NoSuchElementException.class, () -> chatController.createNewChatMessage(1, message.getContent(),
				message.getFromUser(), message.getIsQuiz()));
	}
	...
	public void testCreateNewChatMessageEmptyContent() throws IllegalArgumentException, SQLException {
		...
		Message message = Messages.get("messageUser");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChatMessage(message.getChatId(), "",
				message.getFromUser(), message.getIsQuiz()));
	}
	...
	public void testCreateNewChatMessageNullContent() throws IllegalArgumentException, SQLException {
		...
		Message message = Messages.get("messageUser");
		assertThrows(IllegalArgumentException.class, () -> chatController.createNewChatMessage(message.getChatId(),
				null, message.getFromUser(), message.getIsQuiz()));
	}

	@Test
	public void testGenerateChatMessageResponse()
			throws IllegalArgumentException, NoSuchElementException, SQLException {
		Chat chat = Chats.get("chat1");
		chatController.createNewChat(chat.getName(), chat.getResponseAttitude(), chat.getQuizDifficulty(),
				chat.getEducationLevel(), chat.getStudyArea());

		Message message = Messages.get("messageUser");
		Message userMessage = chatController.createNewChatMessage(message.getChatId(), message.getContent(),
				message.getFromUser(), message.getIsQuiz());
	...
	public void testGenerateChatMessageResponseInvalidFromAI()
		...
		Message aiMessage = chatController.createNewChatMessage(message.getChatId(), message.getContent(),
				message.getFromUser(), message.getIsQuiz());
		assertNotNull(aiMessage);

		assertThrows(IllegalArgumentException.class, () -> chatController.generateChatMessageResponse(aiMessage));
	}
	...
	public void testGetChatMessages() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		for (Message message : Messages.values()) {
			chatController.createNewChatMessage(message.getChatId(), message.getContent(), message.getFromUser(),
					message.getIsQuiz());
		}
	...
	public void testGetChatMessagesInvalidChatId() {
		assertThrows(NoSuchElementException.class, () -> chatController.getChatMessages(1));
	}
	...
	public void testCreateNewQuiz() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		Quiz newQuiz = chatController.createNewQuiz(QuizContent.get("valid"), aiMessage);
		assertNotNull(newQuiz);
		assertEquals(aiMessage.getId(), newQuiz.getMessageId());
	}

	@Test
	public void testCreateNewQuizInvalidNotQuiz()
			throws IllegalArgumentException, NoSuchElementException, SQLException {
		Chat chat = Chats.get("chat1");
		chatController.createNewChat(chat.getName(), chat.getResponseAttitude(), chat.getQuizDifficulty(),
				chat.getEducationLevel(), chat.getStudyArea());
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuiz(QuizContent.get("valid"), aiMessage));
	}
	...
	public void testCreateNewQuizInvalidFromUser()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuiz(QuizContent.get("valid"), userMessage));
	}
	...
	public void testCreateNewQuizInvalidQuizContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuiz(QuizContent.get("invalidQuiz"), aiMessage));
	}
	...
	public void testCreateNewQuizInvalidQuestionContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuiz(QuizContent.get("invalidQuestion"), aiMessage));
	}
	...
	public void testCreateNewQuizInvalidAnswerContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuiz(QuizContent.get("invalidAnswer"), aiMessage));
	}
	...
	public void testCreateNewQuizQuestion() throws IllegalArgumentException, NoSuchElementException, SQLException {
		...
		QuizQuestion newQuizQuestion = chatController.createNewQuizQuestion(QuestionContent.get("valid"), newQuiz);
	...
	public void testCreateNewQuizQuestionExistingNumber()
		...
		assertThrows(IllegalStateException.class,
				() -> chatController.createNewQuizQuestion(QuestionContent.get("valid"), newQuiz));
	}
	...
	public void testCreateNewQuizQuestionInvalidQuestionContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuizQuestion(QuestionContent.get("invalidQuestion"), newQuiz));
	}
	...
	public void testCreateNewQuizQuestionInvalidAnswerContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuizQuestion(QuestionContent.get("invalidAnswer"), newQuiz));

	}

	@Disabled
	public void testCreateNewQuizQuestionAnswer()
			throws IllegalStateException, IllegalArgumentException, NoSuchElementException, SQLException {
		Chat chat = Chats.get("chat1");
		chatController.createNewChat(chat.getName(), chat.getResponseAttitude(), chat.getQuizDifficulty(),
				chat.getEducationLevel(), chat.getStudyArea());
		...
		AnswerOption newAnswerOption = chatController.createNewQuestionAnswerOption(AnswerContent.get("valid"),
				newQuizQuestion);
	...
	public void testCreateNewQuizQuestionAnswerExistingAnswer()
		...
		chatController.createNewQuestionAnswerOption(AnswerContent.get("valid"), newQuizQuestion);
	...
	public void testCreateNewQuizQuestionAnswerInvalidContent()
		...
		assertThrows(IllegalArgumentException.class,
				() -> chatController.createNewQuestionAnswerOption(AnswerContent.get("invalid"), newQuizQuestion));
	}
}
