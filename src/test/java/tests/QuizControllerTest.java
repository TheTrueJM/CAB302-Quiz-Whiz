...
public class QuizControllerTest {
    ...
    public void testGetQuestionAnsweraOption() {
        ...
        AnswerOption answerOption = quizController.getQuestionAnswerOption(findAnswerOption.getQuestionNumber(),
                findAnswerOption.getOption());
    ...
    public void testCreateNewUserAnswer() {
        ...
        UserAnswer newUserAnswer = quizController.createNewUserAnswer(userAnswer.getQuestionNumber(),
                userAnswer.getAnswerOption());
    ...
    public void testCreateNewUserAnswerMuiltipleAttempts() {
        UserAnswer userAnswer = UserAnswers.get("question1Answer");
        UserAnswer firstAttempt = quizController.createNewUserAnswer(userAnswer.getQuestionNumber(),
                userAnswer.getAnswerOption());
        UserAnswer secondAttempt = quizController.createNewUserAnswer(userAnswer.getQuestionNumber(),
                userAnswer.getAnswerOption());
    ...
    public void testCreateNewUserAnswerInvalidQuestion() {
        UserAnswer userAnswer = UserAnswers.get("question1Answer");
        UserAnswer newUserAnswer = quizController.createNewUserAnswer(-1, userAnswer.getAnswerOption());
    ...
    public void testCreateNewUserAnswerInvalidOption() {
        UserAnswer userAnswer = UserAnswers.get("question1Answer");
        UserAnswer newUserAnswer = quizController.createNewUserAnswer(userAnswer.getQuestionNumber(), "WrongOption");
        assertNull(newUserAnswer);
    }
    ...
    public void testGetQuestionUserAnswer() {
        for (UserAnswer userAnswer : UserAnswers.values()) {
            quizController.createNewUserAnswer(userAnswer.getQuestionNumber(), userAnswer.getAnswerOption());
        }
        UserAnswer findUserAnswer = UserAnswers.get("question1Answer");
        UserAnswer userAnswer = quizController.getQuestionUserAnswer(findUserAnswer.getAttempt(),
                findUserAnswer.getQuestionNumber());
